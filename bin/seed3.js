...
.then( (createdAuthors) => {
  ...
  const { books } = splitArr(books);
  const updatedBooks = books.map((book, index) => book.author = createdAuthors[index] );
